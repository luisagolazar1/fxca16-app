...
# ── Tickers ──
USA_TICKERS = [
    "AAPL","NVDA","META","TSLA","AMZN","MSFT","GOOGL","COIN","MELI","SPOT",
    "BABA","PYPL","DIS","SPY","GLD","XLE","AXP","BAC","WFC","C",
    "KO","PG","AAL","CAH","NDAQ","GLOB","VIST","PBR",
]

MERVAL_TICKERS_YF = [
    "AGRO.BA","ALUA.BA","AUSO.BA","BHIP.BA","BMA.BA","BOLT.BA","BPAT.BA",
    "BYMA.BA","CADO.BA","CAPX.BA","CARC.BA","CECO2.BA","CELU.BA","CEPU.BA",
    "CGPA2.BA","CVH.BA","CTIO.BA","DGCU2.BA","EDN.BA","FERR.BA","FIPL.BA",
    "GAMI.BA","GARO.BA","GBAN.BA","GCLA.BA","GGAL.BA","GRIM.BA","HARG.BA",
    "INTR.BA","INVJ.BA","IRSA.BA","LEDE.BA","LOMA.BA","LONG.BA","METR.BA",
    "MIRG.BA","MOLI.BA","MORI.BA","OEST.BA","PAMP.BA","PATA.BA","RICH.BA",
    "RIGO.BA","SAMI.BA","SEMI.BA","SUPV.BA","TECO2.BA","TGNO4.BA","TGSU2.BA",
